...
class DiffSettingsPreferencesPage:
    ...
    def __init__(
        ...
        self.form.setWindowTitle(translate("History", "General"))
        ...
        self._excluded_types_controls = self._build_list_group(
            "excluded_types",
            translate("History", "One TypeId per line."),
        )
        root_layout.addWidget(
            self._wrap_group(
                translate("History", "Excluded object types"),
        ...
        self._excluded_properties_controls = self._build_list_group(
            "excluded_properties",
            translate("History", "One property name per line."),
        )
        root_layout.addWidget(
            self._wrap_group(
                translate("History", "Excluded properties"),
        ...
        self._excluded_by_type_controls = self._build_list_group(
            ...
            translate("History", "One line per mapping: TypeId -> Property"),
        )
        root_layout.addWidget(
            self._wrap_group(
                translate("History", "Type-specific excluded properties"),
        ...
        precision_layout.addRow(translate("History", "Float precision"), self._float_precision_spin)
    ...
    def _build_list_group(self, textarea_name: str, helper_text: str) -> _ListControls:
        default_radio = QtWidgets.QRadioButton(translate("History", "Use default exclusion list"), self.form)
        custom_radio = QtWidgets.QRadioButton(translate("History", "Use custom exclusion list"), self.form)
